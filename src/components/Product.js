...
export default class Product extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="card">
                <div className="img-container p-5" onClick={()=>console.log('Clicked on me')}>
                    <Link to="/details">
                        <img src={img} alt ="Product" className="card-img-top" />
                    </Link>
                    <button className="cart-btn" disabled={inCart ? true : false} onClick = {()=>{console.log(this.props.product)}} >
                        {inCart ? (
                    ...
                    <button className="like" onClick={()=>{console.log('you liked image')}}>
                        {like? (
